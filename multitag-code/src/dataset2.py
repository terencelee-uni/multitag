...
class ImageDataset(Dataset):
    def __init__(self, csv, train, test):
        ...
        self.all_labels = np.array(self.csv.drop(['Id', 'Attributes'], axis=1))
    ...
    def __getitem__(self, index):
        image = cv2.imread(f"../input/photos/Images/{self.image_names[index]}.jpg")
        ...
        return {
            ...
            'name' : self.image_names[index] + ".jpg"
        }
